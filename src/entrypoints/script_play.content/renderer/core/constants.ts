...
export const COLLISION_RANGE = { left: 235, right: 1685 } as const;

export const COLLISION_PADDING = 5;

export const COMMENT_STAGE_SIZE = { fullWidth: 683, height: 384, width: 512 } as const;

export const COMMENT_SCALE = CANVAS_WIDTH / COMMENT_STAGE_SIZE.fullWidth;

export const LINE_BREAK_COUNT = { big: 3, medium: 5, small: 7 } as const;
