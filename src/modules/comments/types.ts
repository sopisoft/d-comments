...
export type CommentManagerDependencies = { service?: CommentService; now?: () => number };

export type CommentManager = { service: CommentService; now: () => number; playing: readonly CommentVideoData[] };
